<?php
ob_start();
session_set_cookie_params(0, '/', '.fundreza.com');
session_start();
...
<html lang="en">
<head>
    <base href="https://account.fundreza.com/">
  <meta charset="utf-8">
  ...
  <title> Fundreza.com  | My account...</title>
...
<div class="sidebar" id="mySidebar">
    ...
    <a href="#" class="brand-link">
      <img src="images/fundrezalogo.png" alt="logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Fundreza</span>
    </a>

    <div class='sidebar' id='mySidebar'>
            <a href='#' class='brand-link'>
              <img src='images/fundrezalogo.png' alt='logo' class='brand-image'
                   style='opacity: .8'>
        
            <div class=''>
              <div class='user-panel mt-3 pb-3 mb-3 d-flex'>
                <div class='image'>";
                 $p_pix = new dbh(); $p_pix -> fetchUserProfilePics(); 
                echo "</div>
                <div class='info'>
    ...
    <div class="wrapper-c">
      ...
      <div class="sfund">
        <div class="row text-center rowcc">
          <div class="col-xs-12 col-sm-12 col-md-3 mt-4 mb-2">
            <a class="nfu1" href="https://fundreza.com/s/choose-type"><i class="fas fa-dollar-sign"></i> Start A New Fundraiser</a>
          </div>

          <div class="col-xs-12 col-sm-12 col-md-3 mt-4 mb-2">
            <form action="" method="post">
              <button type="submit" name="myFundraisers" class="nfu3" style="color:#22a349;"> <i class="fas fa-donate"></i> My Fundraisers </button>
            </form>  
          </div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 mt-4 mb-2">
            <a href="<?php echo "https://mywithdrawal.fundreza.com/w/setwithdrawal/$med"?>" class="text-danger nfu3"> <i class='fas fa-credit-card'></i> Request Withdrawal </a>
      ...
      <div class="row diva">
        ...
        <div class="mfr">
              ...
              $mfr = new dbh(); $mfr -> continueFundraizerSetUp();
              
                if(isset($_POST['shareFundraisers'])) {
                    $mfr = new dbh(); $mfr -> shareFundraisers();
                }else if(isset($_POST['myFundraisers'])) {
                    $mfr = new dbh(); $mfr -> myFundraisers();
                }else if(isset($_POST['delFundraiser'])) {
            ...
            <?php }}else { ?>
              ...
              <div class="mfrw">
                <div class="w-fw mx-auto text-center">
                    ...
                    <div class="nh text-center mt-3"><a type="submit" href="<?php echo "https://account.fundreza.com/kyc/$med"?>" class="nf p-2 m-2 mt-5 text-white"> Upload now</a></div> 
                </div>
            </div>
          ...
          <div class="mfrw">
              <div class="w-fw">
                <div class="ind text-center">
                  ...
                  <div class="nhf">
                    <i class="fas fa-envelope"></i> help@fundreza.com
                  </div>
                  <div class="nhf">
