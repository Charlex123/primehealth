...
public $serverdbname = "fundgcmf_primehealth";
...
try{ 
  $con= new PDO("mysql:host=$this->serverhost;dbname=fundgcmf_primehealth;" , $this->serverusername, $this->serverpassword);
...
public function topFollowers() {
    try{
        ...
        $name = $user_data['uname'];
        $email = $user_data['email'];
        // SELECT parentcomments.uname,parentcomments.likes,parentcomments.dislikes,parentcomments.comment,parentcomments.commentupload,parentcomments.documentType,parentcomments.fileType,users.profile_pics,parentcomments.comment_time,parentcomments.emp_code,parentcomments.commentCode FROM parentcomments INNER JOIN users ON parentComments.uname = users.uname  WHERE parentcomments.emp_code = ? ORDER BY parentcomments.comment_time DESC LIMIT 20
        $con = new PDO("mysql:host=$this->serverhost;dbname=fundgcmf_primehealth;" , $this->serverusername, $this->serverpassword);
        $con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
...
public function fundraiserList() {
    ...
    try{
        ...
        $sql -> execute();
            ...
            // pagination code
                ...
                echo "<div class='p-2 m-3 nf font-weight-normal' style='white-space:nowrap'> No Fundraiser Found <a target='_blank' href='https://fundreza.com/s/choose-type' class='text-decoration-none text-warning'> Start A new Fundraiser </a> <span class='close-err'>&times;</span> </div>";
                return false;
 ...
 public function shareFundraisers() {
    try{
        ...
        LEFT JOIN donation_table ON fundraiser_table.fundraiserId = donation_table.fundraiserId WHERE fundraiser_table.fundraiserThumbnail <> '' AND fundraiser_table.fundraiserEmail = ? GROUP BY fundraiser_table.fundraiserId ORDER BY fundraiser_table.dateSubmitted AND donation_table.donation_time DESC LIMIT 10");
        $sql -> bindParam(1,$email);
        $sql -> execute();
                        ...
                        <div class='mb-3 position-relative'>
                            ...
                            <div class='f-con'>
                                ...
                                <div class='p-con  mb-3 mt-3'>
                                    <div class='amtt'>
                                        <div class='amtraisedc'>$<span class='amtraised' name='$testdna'>$testdona</span> raised of</div> 
                            ...
                            <div class='mf mx-auto mt-4 mb-3 text-center' style='border-top: 1px solid #cccccc;'><a href='../share/share-with-family-and-friends/$fundraiserId' style='cursor:pointer;text-decoration: none;color: #ffffff;margin: 2rem auto;text-align: center;' name='$fundraiserId' aria-haspopup='true' aria-expanded='false' class='shFFn nf'> Share Fundraiser Now </a></div>
                        </div>
    ...
    try{
        ...
        $sql -> execute();
            ...
            // pagination code
                ...
                $rows = $sql -> fetchALL(PDO::FETCH_ASSOC);
                // var_dump($rows);
                echo "<h2 class='mt-5 oda-c'> Other Campaigns you may like </h2>";
                echo "<div class='row'>"; 
                foreach($rows as $row) {
                    ...
                    <div class='funda text-center'>
                        <div class='mb-3 position-relative'>
                            ...
                            <div class='f-con'>
                                ...
                                <div class='mfrscc pt-2 pb-2 pl-1'> <div class='mfrsc-time'> Last donation received: $fundraisertime </div> <div class='mfrsc-eyev icc'><i class='far fa-heart'></i> $donationcount</div> </div>
                            </div>
                        </div>
 ...
 public function continueFundraizerSetUp() {
    try{
        ...
        $con = new PDO("mysql:host=$this->serverhost;dbname=fundgcmf_primehealth;" , $this->serverusername, $this->serverpassword);
        $con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = $con -> prepare("SELECT fundraiserId FROM fundraiser_table WHERE (fundraiserGoal = 0 || fundraiserThumbnail = '') AND fundraiserEmail = ? ORDER BY datesubmitted DESC");
        $sql -> bindParam(1,$email);
        $sql -> execute();
            ...
            if($sql -> execute() && $sql -> rowCount() > 0) {
                ...
                $fid = $f['fundraiserId'];
                echo "<div class='p-2 m-3 nf font-weight-normal' style='white-space:nowrap' style='white-space: nowrap'> <a target='_blank' href='https://fundreza.com/funding/set/fundraising-goal/individual/$fid' class='text-decoration-none text-warning'> Continue Your Unfinished Fundraiser SetUp </a> <span class='close-err'>&times;</span> </div>";
        ...
        $sql -> execute();
            ...
            // pagination code
                ...
                foreach($rows as $row) {
                    ...
                    // $shares = $row['totalShares'];
                    // $upvotes = $row['totalupVotes'];
                    $fundraiserThumbnail = 'https://fundreza.com/'.$row['fundraiserThumbnail'];
                    $time = $row['donation_time'];
                    $categ = $row['fundraiserCategory'];
                    $category = str_replace("-"," ", $categ);
                ...
                echo "<div class='col-xs-12 col-sm-6 col-md-6 col-lg-4 pt-2 pb-2 defa' style=''>";
                ...
                echo "<div class='mfrs'>";
                    ...
                    echo "<div class=' bg-white'>
                            ...
                            <div class='mfrsc mx-auto text-center'>
                                ...
                                <div class='fupo'>
                                    <div class='mf border-0'><a rel='nofollow' style='cursor:pointer' data-toggle='modal' data-target='#manageF' name='$fundraiserId' aria-haspopup='true' aria-expanded='false' class='fupp nf text-white'> Share Fundraiser Progress Update </a></div>
                                    <div class='mfd'>
                                        <div class='mf border-0 drei'><form method='POST'><input type='varchar' name='delFundraiser' value='$fundraiserId' hidden><button type='submit' name='submit' class='nav-btn  border-0 bg-danger'> <i class='fas fa-trash'></i> Delete </button></form></div>
                                        <div class='mf border-0 drai'><form method='POST'><a href='https://account.fundreza.com/edit/$fundraiserId' class='prv text-dark'> <i class='fas fa-edit'></i> Edit </a></form></div>    
                                    </div><div class='end-float'></div>
                                </div>    
                            </div>
                ...
                echo "<div class='p-2 m-3 nf font-weight-normal' style='white-space:nowrap' style='white-space: nowrap'> No Fundraiser Found <a target='_blank' href='https://fundreza.com/s/choose-type' class='text-decoration-none text-warning'> Start A new Fundraiser </a> <span class='close-err'>&times;</span> </div>";
                return false;
