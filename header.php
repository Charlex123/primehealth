            ...
            <div class="row hidden-xs styles__top-row___1GOEC" >
                <div class="col-sm-8 styles__top-right-col___2VrGG">
                    ...
                    <ul itemscope="" itemtype="https://www.schema.org/SiteNavigationElement" class="styles__list-navigation___3k1hk">
                        ...
                        <li itemprop="name" data-auto-navlinks="Labs" class="">
                            <a
                                itemprop="url"
                                href="labsa4cb.html?utm_source=1mg&amp;utm_medium=jewel&amp;utm_campaign=labsgrowth"
                                class="button-text t-service-labs web-left-nav glow1"
                                target="_blank"
                                data-vars-event-label="Labs"
                            >
                            <i class="fa fa-map-marker"></i> Labs Near You
                            </a>
                        </li>
                        <li itemprop="name" data-auto-navlinks="Doctors" class="">
                            <a itemprop="url" href="online-doctor-consultation.html" class="glow2" target="_blank" data-vars-event-label="Doctors"><i class="fa fa-map-marker"></i> Doctors Near You</a>
                        </li>
                        <li itemprop="name" data-auto-navlinks="Doctors" class="">
                            <a itemprop="url" href="online-doctor-consultation.html" style="color: #888888" target="_blank" data-vars-event-label="Doctors"> CONSULT A DOCTOR</a>
                        </li>
                    </ul>
                </div>
